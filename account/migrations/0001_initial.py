    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('updatedDate', models.DateTimeField(blank=True, null=True)),
                ('media', models.FileField(blank=True, default=None, null=True, upload_to='socialmedia/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activityCreator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
