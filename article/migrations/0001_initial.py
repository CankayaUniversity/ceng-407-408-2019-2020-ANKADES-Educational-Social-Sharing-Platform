    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.ArticleCategory', verbose_name='Üst Kategorisi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view', models.PositiveIntegerField(default=0, verbose_name='Makale Görüntülenme Tarihi')),
                ('isActive', models.BooleanField(default=True, verbose_name='Aktiflik')),
                ('categoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.ArticleCategory', verbose_name='Makale Kategori')),
