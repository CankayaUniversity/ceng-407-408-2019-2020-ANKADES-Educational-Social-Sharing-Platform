...
urlpatterns = [
    ...
    url(r'^isactive-question-category/(?P<slug>[\w-]+)/$', question.admin_isactive_question_category,
         name="admin_isactive_question_category"),
    path('edit-question-category/<slug:slug>/', question.admin_edit_question_category,
         name="admin_edit_question_category"),
