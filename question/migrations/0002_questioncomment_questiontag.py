    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questionId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='question.Question', verbose_name='Makale')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Cevap', to='question.QuestionComment')),
                ('questionId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='question.Question', verbose_name='Makale Yorumcusu')),
            ],
            options={
