...
class QuestionComment(models.Model):
    ...
    questionId = models.ForeignKey(Question, on_delete=models.CASCADE, verbose_name="Makale Yorumcusu")
...
class QuestionTag(models.Model):
    ...
    questionId = models.ForeignKey(Question, on_delete=models.CASCADE, verbose_name="Makale")
