...
def all_courses(request):
    ...
    if keyword:
        ...
        return render(request, "ankades/course/courses.html", context)
...
def course_categories(request):
    ...
    if keyword:
        ...
        return render(request, "ankades/course/courses.html", {"searchCategories": searchCategories})
    categories = CourseCategory.objects.all()
    return render(request, "ankades/course/courses.html", {"categories": categories})
...
def course_detail(request, slug):
    ...
    return render(request, "ankades/course/course-detail.html", context)
