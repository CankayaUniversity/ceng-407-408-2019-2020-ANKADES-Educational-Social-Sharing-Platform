...
class CourseComment(models.Model):
    ...
    courseId = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="Makale Yorumcusu")
...
class CourseTag(models.Model):
    ...
    courseId = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="Makale")
